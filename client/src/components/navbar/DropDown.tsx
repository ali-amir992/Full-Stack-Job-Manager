    ...
    return (
        <div className="lg:inline-block hidden relative whitespace-nowrap" ref={dropdownRef}>
            <button
                ...
                className="flex items-center text-richblack-25 hover:text-primary py-2 rounded-md text-md"
            >
                {label}
                <svg
            ...
            {isOpen && (
                <div className="absolute bg-richblack-600  right-0 mt-2 w-48 shadow-lg rounded-md z-10">
