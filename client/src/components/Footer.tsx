...
const Footer = () => {
    return (
        <div className="border-t-richblack-600 bg-richblack-800 border-t">

            <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-8 sm:px-6 lg:space-y-8 ">
                ...
                <div
                    className="grid gap-8 border-t  pt-4 grid-cols-2 lg:grid-cols-3 lg:pt-8"
                >
                    <div>
                        ...
                        <ul className="mt-6 space-y-4 text-sm">
                            ...
                            <li>
                                <a href="#" className=" transition hover:opacity-75"> Evaluation Criteria </a>
                            </li>
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4 text-sm">
                            ...
                            <li>
                                <a href="#" className=" transition hover:opacity-75"> Our partners </a>
                            </li>
                        </ul>
                    </div>
